...
client.on("interactionCreate", async (Interaction) => {
    ...
    if(Interaction.isButton()) {
        ...
        if(Interaction.customId === "PassiveGame") {
            let responses = ["Hypixel SMPs", "[arcade] Hole in the Wall", "[arcade] Pixel Painters", "[arcade] Hypixel Says"]
            let response = Math.floor(Math.random() * responses.length)
            Interaction.channel.send(responses[response])
            Interaction.deferUpdate()
        }
        ...
        if(Interaction.customId === "StrategyGame") {
            let = responses = ["[murder mystery] Classic", "[murder mystery] Double up", "[murder mystery] Infection (v2)", "[arcade] Creeper Attack", "[arcade] Hole in the Wall", "[arcade] Football", "[arcade] Capture the Wool", "[arcade] Hide and Seek Party Poopers", "[arcade] Hide and Seek Prop Hunt", "[arcade] Zombies", "[arcade] Blocking Dead", "[arcade] Hypixel Says", "[build battle] Solo", "[build battle] Teams", "[build battle] Guess the Build", "UHC", "[TNT Games] Bow Spleef", "[TNT Games] TNT Run", "[TNT Games] TNT Tag", "[Arcade] Pixel Party", "[PTL] Dropper", "Wool Wars"]
            let response = Math.floor(Math.random() * responses.length)
            Interaction.channel.send(responses[response])
            Interaction.deferUpdate()
        }
        ...
        if(Interaction.customId === "ShortGame") {
            let responses = ["[murder mystery] Assassins", "[bedwars] Solos", "[bedwars] Doubles", "Skywars Solo Insane", "Skywars Solo Normal", "Skywars Teams Insane", "Skywars Teams Normal", "[duel] UHC", "[duel] UHC Deathmatch", "[duel] Skywars", "[duel] MegaWalls", "[duel] Sumo", "[duel] OP", "[duel] The Bridge", "[duel] Bow", "[duel] Classic", "[duel] NoDebuff", "[duel] Blitz", "[duel] Combo", "[duel] Bow Spleef", "[duel] UHC Doubles", "[duel] UHC Teams", "[duel] Skywars Doubles", "[duel] MegaWalls Doubles", "[duel] OP Doubles", "[duel] The Bridge Doubles", "[duel] The Bridge Teams", "[duel] The Bridge 2v2v2v2", "[duel] The Bridge 3v3v3v3", "[TNT Games] PVP Run", "[TNT Games] Wizards", "[TNT Games] TNT Run", "[arcade] Hypixel Says", "[murder mystery] Classic", "[murder mystery] Double up", "[murder mystery] Infection (v2)", "[arcade] Hide and Seek Party Poopers", "[arcade] Hide and Seek Prop Hunt", "[Arcade] Pixel Party", "[PTL] Dropper", "Wool Wars"]
            let response = Math.floor(Math.random() * responses.length)
            Interaction.channel.send(responses[response])
            Interaction.deferUpdate()
        }
